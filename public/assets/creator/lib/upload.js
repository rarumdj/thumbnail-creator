    ...
    const processFiles = (files) => {
      ...
      for (let file of files) {
        ...
        reader.onload = (f) => {
          ...
          $('#uploadedImgContainer').append(`<div class="col-6">
                  <a href="#" class="app-rounded-5 media-image-file overflow-hidden" style="max-height: 120px;">
                      <img class="w-100 app-img-cover app-rounded-5 overflow-hidden" height="120" style="max-height: 120px;" src="${f.target.result}">
                  </a>
              </div>`);
        }
