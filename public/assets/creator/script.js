try {
  ...
  const shapes = [
    ...
    `<svg baseProfile="tiny" x="0px" y="0px" viewBox="0 0 32 32" ><defs><clipPath id="_clip_rv38zu0ca"><rect x="0" y="0" rx="0" ry="0" width="32" height="32"></rect></clipPath></defs><rect class="shape" x="0" y="0" rx="0" ry="0" fill="#444444" stroke="none" stroke-width="0" stroke-dasharray="0" width="32" height="32" vector-effect="non-scaling-stroke" clip-path="url(#_clip_rv38zu0ca)"></rect></svg>`,
