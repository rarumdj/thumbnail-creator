!(function (t) {
    ...
    function o(t) {
        ...
        return function (o) {
            var n = o.match(/%(-|!)?[A-Z]{1}(:[^;]+;)?/gi);
            if (n)
                for (var a = 0, l = n.length; a < l; ++a) {
                    var h = n[a].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/),
                        r = s(h[0]),
                        c = h[1] || "",
                        f = h[3] || "",
                        u = null;
                    (h = h[2]),
                        e.hasOwnProperty(h) && ((u = e[h]), (u = Number(t[u]))),
                        null !== u &&
                            ("!" === c && (u = i(f, u)),
                            "" === c && u < 10 && (u = "0" + u.toString()),
                            (o = o.replace(r, u.toString())));
                }
            return (o = o.replace(/%%/, "%"));
        };
    }
    ...
    (l.prototype.start = function () {
        ...
        (l.prototype.setFinalDate = function (t) {
            this.finalDate = e(t);
        }),
            ...
            return this.each(function () {
                ...
                if (void 0 !== s) {
                    ...
                    l.prototype.hasOwnProperty(i)
                        ? o[i].apply(o, e.slice(1))
                        : null === String(i).match(/^[$A-Z_][0-9A-Z_$]*$/i)
                        ? (o.setFinalDate.call(o, i), o.start())
                        : t.error(
