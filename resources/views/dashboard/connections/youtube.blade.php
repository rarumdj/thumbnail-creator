...
@section('content')
    <section class="nav-section bg-white border-bottom py-3">
        <div class="container">
            <div class="d-flex flex-column flex-md-row justify-content-md-between justify-content-start align-items-lg-start">
                <div class="">
                    <h4 class="mb-0">
                        <span class="app-text-denim-900">Youtube Videos</span>
                    </h4>
                    <small class="text-muted small">See your youtube videos</small>
                </div>
                <div class="">
    ...
    {{-- LIVEWIRE FOR YOUTUBE --}}
    @livewire('youtube-videos', ['videos' => $videos ?? []])
@endsection
@section('modals')
   {{-- SELECT THUMBNAIL --}}
            ...
            <div class="modal-body">
                <div class="row g-3">
                    @isset($templates)    
                        ...
                        @empty
                            <h2>No thumbnail created yet</h2>
                        @endforelse
                    @else
                        <h2>No thumbnail created yet</h2>
                    @endisset
