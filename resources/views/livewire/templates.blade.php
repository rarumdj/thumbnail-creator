<div>
    ...
    <section class="">
        <div class="container">
            ...
            <div class="pb-3">
                <h2 class="border-bottom border-2 fs-5 app-text-gray-700 pb-2">MY DESIGNS</h2>
            </div>
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <a href="#"
                                        ...
                                        <div class="flex-grow-1 ms-2">
                                            <h6 class="mb-1 text-truncate">{{ ucwords($template->template_name) }}</h6>
                                    ...
                                    <div class="dropup">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="uniqueId">
                                            <li><a class="dropdown-item" href="/creator/{{ $template->id }}"><i
                                                        class="bi-pencil-square pe-2"></i> Edit</a></li>
                                            <li><a wire:click.prevent="showDuplicateModal('{{ $template->id }}')"
                                                    class="dropdown-item" href="#"><i class="lar la-copy fs-5"></i>
                                                    Duplicate</a></li>
                                            <li><a class="dropdown-item" href="#"><i class="bi-download pe-2"></i>
                                                    Download</a></li>
                                            <li><a wire:click.prevent="setTemplateToShare({{ $template->id }})"
                                                    class="dropdown-item" href="#"><i class="bi-share pe-2"></i>
                                                    Share</a></li>
                                            <li><a wire:click.prevent="setTemplateToDelete('{{ $template->id }}')"
                                                    class="dropdown-item" href="#"><i class="bi-trash pe-2"></i>
                                                    Delete</a></li>
                                        </ul>
                                    </div>
                                </div>
